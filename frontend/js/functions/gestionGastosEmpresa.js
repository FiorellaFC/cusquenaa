document.addEventListener('DOMContentLoaded', () => {
    ...
    function renderGastos(gastos, totalGeneralMonto) {
        ...
        if (gastos.length === 0) {
            tablaGastos.innerHTML = '<tr><td colspan="5" class="text-center">No hay gastos para mostrar.</td></tr>';
    ...
    function setupPagination(totalRecords, currentPageNum, recordsPerPageNum) {
        ...
        if (startPage > 1) {
            ...
            if (startPage > 2) {
                paginationContainer.appendChild(createPageItem('...', '...', true));
            }
        }
